...
```powershell
iwr https://github.com/Viniciusap/selfdesk/releases/latest/download/selfdesk-agent-win-x64.zip -OutFile agent.zip
Expand-Archive agent.zip -DestinationPath selfdesk-agent; cd selfdesk-agent
